	...
	public function resend()
	{
		...
		else
		{
			if ($account = Users_Model::can_resend($this->input->post('username', true), $this->input->post('email', true)))
			{
				...
				$this->email->to($account->get_email_address());
				...
				$this->session->set_flashdata('success', 'An email has been sent to ' . $account->get_email_address() . ' with further instructions.');
				redirect('/');
			}
			else
			{
	...
	public function create()
	{
		...
		else
		{
			...
			if (isset($response['success']) && $response['success'] === true)
			{
				...
				$this->session->set_flashdata('success', 'An email has been sent to ' . $this->input->post('email_address', true) . ' with further instructions.');
				redirect('/');
			}
			else
			{
